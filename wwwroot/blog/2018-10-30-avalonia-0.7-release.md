...
We are pleased to annouce that [Avalonia](https://github.com/AvaloniaUI/Avalonia) 0.7 has been released.

This is a big release and we can now truly say that you can build your UI once and on all desktop platforms.
...
@grokys @jkoritzinsky @kekekeks @jmacato @wieslawsoltes @gillibald @donandren @sdoroff @boombuler @walter
